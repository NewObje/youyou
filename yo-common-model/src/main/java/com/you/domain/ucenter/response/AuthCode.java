...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN_AUTH_SERVER_NOTFOUND(false,23007,"登陆认证服务未找到！"),
    AUTH_LOGIN_APPLY_TOKEN_FAIL(false,23008,"登陆认证申请token失败！"),
    AUTH_LOGIN_TOKEN_SAVE_FAIL(false,23009,"token保存失败！");
    //操作代码

...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_FILE_REGISTER_NOT_EXIST(false,22006,"上传文件在系统注册为空！"),
    CHUNK_FILE_UPLOAD_FAILED(false,22007,"分块文件上传失败！"),
    MERGE_FILE_CREATE_FAILED(false,22008,"合并文件失败失败！"),
    FILE_IS_NOT_UPLOAD(false,22009,"请上传视频！"),
    FILE_PIC_IS_NOT_EXIST(false,22010,"视频封面不存在！"),
    FILE_IS_NOT_EXIST(false,22011,"视频不存在！"),
    FILE_IS_POSTED(false,22012,"视频已发布！");
